...
**Эпистемический статус:** `INSTITUTIONAL_MODEL` & `RESEARCH_THEORY` (формальная архитектурно-математическая и термодинамическая модель; не является нормативным или государственным актом).  
